...
function UserProfile(props: RouteComponentProps<RouteProps>) {
  ...
  }, [setProfileData, setUserPosts, props.match.params.id]);
    ...
    <>
      <div className='profile-view'>
        <div className='profile-banner'>
          <img alt="profile" id='profile' src={profileData.photoURL}/>
        ...
        <div className='info-box'>
          ...
          <div className='info-item'>
            <img alt="join date" title='Date joined' src={process.env.PUBLIC_URL + "/assets/calendar.png"}/>
            <span>{profileData.dateCreated}</span>
          </div>
          <div className='info-item'>
            <img alt="user location" title='Location' src={process.env.PUBLIC_URL + "/assets/location.png"}/>
            <span>{profileData.location}</span>
          </div>
          <div className='info-item'>
            <img alt="occupation" title='Occupation' src={process.env.PUBLIC_URL + "/assets/occupation.png"}/>
